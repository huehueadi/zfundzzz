      ...
      <div className="row dz-terms">
          ...
          <aside className="side-bar sticky-top">
            <div className="dz-terms-list">
              <ul className="navbar-nav navbar-scroll">
                <li><a href="#scrollNavSection01" className="nav-link scroll">Terms And CareerExplorer</a></li>
                <li><a href="#scrollNavSection02" className="nav-link scroll">User Account</a></li>
                <li><a href="#scrollNavSection03" className="nav-link scroll">Electronic Communication</a></li>
                <li><a href="#scrollNavSection04" className="nav-link scroll">User Data And Privacy</a></li>
                <li><a href="#scrollNavSection05" className="nav-link scroll">Ownership Of CareerExplorer</a></li>
                <li><a href="#scrollNavSection06" className="nav-link scroll">Additional Terms</a></li>
                <li><a href="#scrollNavSection07" className="nav-link scroll">Your Responsibilities</a></li>
                <li><a href="#scrollNavSection08" className="nav-link scroll">Communications Not Confidential</a></li>
                <li><a href="#scrollNavSection09" className="nav-link scroll">Feedback</a></li>
                <li><a href="#scrollNavSection10" className="nav-link scroll">Contact</a></li>
              </ul>
            </div>
          </aside>
        </div>
        <div className="col-xl-8 col-lg-7">
          ...
          <div className="dz-terms-content" id="scrollNavSection10">
            ...
            <p>If you have any questions or comments regarding these Member Terms, please contact us at <strong><a className="text-dark gmail" target="_blank" href="mailto:dexignzones@gmail.com">dexignzones@gmail.com</a></strong></p>
          </div>
        </div>
      </div>
    </div>
